...
- [buger/jsonparser](https://github.com/buger/jsonparser) - One of the fastest alternative JSON parser for Go that does not require schema (2 days ago)
- [tidwall/sjson](https://github.com/tidwall/sjson) - Set JSON values very quickly in Go (2 days ago)
