...
- [cwida/duckpgq-extension](https://github.com/cwida/duckpgq-extension) - DuckDB extension that adds support for SQL/PGQ and graph algorithms (today)
- [indradb/indradb](https://github.com/indradb/indradb) - A graph database written in rust (6 days ago)
