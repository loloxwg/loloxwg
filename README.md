...
- [Add Chinese README for deduplication indexing module](https://github.com/loloxwg/netsdb/pull/2) on [loloxwg/netsdb](https://github.com/loloxwg/netsdb) (5 days ago)
...
- [Wind-Gone/OceanBase-Contest-Miniob](https://github.com/Wind-Gone/OceanBase-Contest-Miniob) - Alibaba OceanBase group&#39;s preliminary contest code implementation (3 days ago)
- [Wind-Gone/awesome-olap-paper](https://github.com/Wind-Gone/awesome-olap-paper) - Paper related to OLAP database systems (3 days ago)
- [luooofan/miniob-2023](https://github.com/luooofan/miniob-2023) - 2023 OceanBase 数据库大赛初赛 (3 days ago)
- [HazyResearch/minions](https://github.com/HazyResearch/minions) - Big &amp; Small LLMs working together (5 days ago)
- [alitrack/duckdb_fdw](https://github.com/alitrack/duckdb_fdw) - DuckDB Foreign Data Wrapper for PostgreSQL (5 days ago)
