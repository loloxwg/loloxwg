...
- [feat(copy): add support for file copying operations in database](https://github.com/KipData/KipSQL/pull/75) on [KipData/KipSQL](https://github.com/KipData/KipSQL) (4 weeks ago)

#### ⭐ Recent stars

- [ProgrammingRust/fingertips](https://github.com/ProgrammingRust/fingertips) - Rust code to build an inverted index for a corpus of text files. (1 day ago)
