...
- [feat(version_log): 为 version_log 增加快照功能](https://github.com/KKould/KipDB/pull/4) on [KKould/KipDB](https://github.com/KKould/KipDB) (3 days ago)
- [fix(version_log):统一写入，防止写入日志时宕机，在重启后恢复部分VersionEdit的内容](https://github.com/KKould/KipDB/pull/2) on [KKould/KipDB](https://github.com/KKould/KipDB) (2 weeks ago)
