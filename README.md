...
- [cmu-db/optd-experimental](https://github.com/cmu-db/optd-experimental) - Extensible SQL Query Optimizer Service (1 day ago)
- [spacejam/sled](https://github.com/spacejam/sled) - the champagne of beta embedded databases (3 days ago)
- [mxsm/rocketmq-rust](https://github.com/mxsm/rocketmq-rust) - 🚀Apache RocketMQ Rust🦀 implementation. Faster, safer, and with lower memory usage. (6 days ago)
