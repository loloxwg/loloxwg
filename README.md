...
- [OpenDCAI/DataFlow](https://github.com/OpenDCAI/DataFlow) - Easy Data Preparation with latest LLMs-based Operators and Pipelines. (2 days ago)
- [temporalio/temporal](https://github.com/temporalio/temporal) - Temporal service (4 days ago)
- [langgenius/graphon](https://github.com/langgenius/graphon) - Graphon is a Python graph execution engine for agentic AI workflows. (4 days ago)
